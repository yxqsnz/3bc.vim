sy case ignore 
sy keyword _3bcKeyword NILL MODE STRI FREE MATH GOTO NB02 STRC ALOC FGTO NB08 STRO MOFF PULL ZGTO NB10 STRX PGTO MUSE SPIN NB16 MMAX NGTO PUSH MMIN SKIP 
